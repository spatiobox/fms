...
var DictionaryService = (function () {
    ...
    DictionaryService.prototype.copy = function (node) {
        var _url = this.url + '/{id}/copy/{uid}'.replace('{id}', node.SourceID).replace('{uid}', node.TargetID);
        return this.http.post(_url, {}, { headers: this.getToken() });
    };
    DictionaryService.prototype.patch = function (id, data) {
        var _url = this.url + '/{id}'.replace('{id}', id);
        return this.http.patch(_url, JSON.stringify(data), { headers: this.getToken() });
    };
    DictionaryService.prototype.delete = function (id) {
        var _url = this.url + '/' + id;
        return this.http.delete(_url, { headers: this.getToken() });
    };
    DictionaryService.prototype.download = function () {
        var _url = this.url + '/template';
        return this.http.get(_url, { headers: this.getToken() });
    };
    DictionaryService.prototype.search = function (node) {
        var _url = this.url + '/search';
        return this.http.post(_url, JSON.stringify(node), { headers: this.getToken() });
    };
    DictionaryService.prototype.import = function () {
    };
    DictionaryService.prototype.export = function () {
    };
    DictionaryService.prototype.getToken = function () {
