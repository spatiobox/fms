...
exports.Oms = {
    ...
    CreateGuid: (function(uuidRegEx, uuidReplacer) {
        return function() {
    ...
    showMsg: function(key) {
        var arr = key.split(' ');
        var spliter = exports.Oms.lang == 'en-US' ? ' ' : '';
        var result = '';
        arr.forEach(function(item) {
            result += spliter + (exports.Oms.Region[exports.Oms.lang][item] || exports.Oms.Messages[exports.Oms.lang][item] || item || '');
        });
        alert(result);
    },
...
//# sourceMappingURL=oms.config.js.map